...
export default function AlertCancelOption({ title, description, status = 'success', onAccept, onCancel }) {
  const isSuccess = status === 'success';
  
  return (
    <div className={`bg-white rounded-lg shadow-md p-5 m-4 max-w-md min-w-80 flex flex-col gap-2 relative ${
      ...
      <div className="text-base my-1.5 mb-3">{description}</div>
